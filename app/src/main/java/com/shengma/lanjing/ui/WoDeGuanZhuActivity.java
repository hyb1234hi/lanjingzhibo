...
public class WoDeGuanZhuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(WoDeGuanZhuActivity.this, LinearLayoutManager.VERTICAL,false);
        //设置布局管理器
    ...
    private void link_list() {
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                ToastUtils.showError(WoDeGuanZhuActivity.this,"获取数据失败,请检查网络");
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    ToastUtils.showError(WoDeGuanZhuActivity.this,"获取数据失败");
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            swipeRefreshLayout.setRefreshing(false);
