 ...
 * @author Tom.Cai
 */
public class TuiChuDialog2 extends Dialog {

    private Button button1,button2;


    public TuiChuDialog2(Context context) {
        super(context, R.style.dialog_style2);
        setCustomDialog();
    }

    private void setCustomDialog() {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.tuichu_dialog2, null);
